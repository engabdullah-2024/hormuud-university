...
// ===== Animations (typed to avoid TS/ESLint issues) =====
...
export default function FacilitiesPage() {
  return (
    <main className="min-h-screen bg-muted/30">
        ...
        <div className="relative mx-auto flex max-w-6xl flex-col gap-8 px-4 py-16 md:flex-row md:items-center md:py-20 lg:px-6">
          ...
          >
            ...
            <p className="max-w-lg text-sm text-emerald-50/90 md:text-base">
              From quiet libraries and advanced engineering labs to sports fields
              and prayer spaces, Hormuud University&apos;s facilities are built to
              support the whole student — academically, professionally and
              personally.
            </p>
      ...
      >
        <motion.header className="space-y-2" variants={sectionFadeUp}>
          ...
          <p className="max-w-2xl text-sm text-muted-foreground md:text-base">
            Our engineering labs allow students to connect theory with real-world
            practice — through experiments, fieldwork and project-based learning.
          </p>
        </motion.header>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {labs.map((lab, index) => (
            ...
            >
              <Card className="flex h-full flex-col overflow-hidden border-slate-200 bg-background/90 shadow-sm transition-transform hover:-translate-y-1 hover:shadow-md">
      ...
      >
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {campusLife.map((item, index) => (
            ...
            >
              <Card className="flex h-full flex-col overflow-hidden border-slate-200 bg-background/95 shadow-sm transition-transform hover:-translate-y-1 hover:shadow-md">
                <div className="relative w-full overflow-hidden">
                  <div className="relative aspect-[4/3]">
                    <Image
                      src={item.image}
              ...
              <CardHeader className="flex flex-row items-start gap-3 space-y-0">
                ...
                <div>
                  ...
                  <p className="text-xs text-emerald-900/80 md:text-sm">
                    ...
                    monitored campus so students can focus on learning and
                    growth.
                  </p>
                </div>
              </CardHeader>
        ...
        {/* Icons mini-row */}
        <motion.div
          className="mt-4 flex flex-wrap items-center gap-6 text-xs text-muted-foreground md:text-sm"
          variants={sectionFadeUp}
          initial="hidden"
          whileInView="visible"
